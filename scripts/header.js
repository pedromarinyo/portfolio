...
aboutContent["debate"] = "September 29th, Trump and Biden took to the stage to hold this election's first presidential debate. Debate is a storied institution, we're told, hailing from such a pedigree that participants, on good faith alone, were expected to abide by agreed-upon rules. What resulted was a nonsensical cascade of interruptions as Wallace, the debate's moderator, desperately tried to reign spurious accusations, masculine showboating and petty insults into the quarter of productive policy distinctions.<br><br><i>Debate Is (Not) a Lullaby</i> is a music generator that plays with the characterization of the debaters as mud-slinging schoolchildren.<br><br><a href='https://pedromarinyo.github.io/debateLullaby/'>Visit the project.</a><br><br><img width='100%' class='projectDetailsImg' src='assets/debate1.png'>";


aboutContent["monsterPocket"] = "Every iteration of Pokémon begins with our player-character being gifted his/her choice of Pokémon, and from there, utilizing their creature to accrue others; here, like capital begets capital, Pokémon are the essential tool for collecting more Pokémon. <br><br><b>Critiquing Assumptions</b>:<br>The design decisions behind this world are pragmatic. On behalf of players’ comfort, this world-design obfuscates the franchise’s underlying metaphor, that is, one of servitude and transparency that’s especially problematic for minorities in the U.S. The Pokémon-centered world appears precisely crafted for facilitating these teenagers' journeys. The Pokémon world is not so much a world, but a specially built stage for these youngsters’ trial-and-error stumbling toward adulthood. That cataloging the world’s creatures requires their capture, their sequestering away into pokéballs and their continued deployment in battle, all foregrounds these creatures' status as collectables, as signifiers of status and capital. In-game messaging makes clear: These creatures are valued for their utility; they don’t have interior lives worth considering. <br><br><b>Inverting Assumptions</b>:<br>In my reimagining, I attempt to invert the following assumptions by casting players in the role of the Pokemon, a Bulbasaur who's relegated to living inside sparse confines unless called upon to commit violence to his fellow creatures.<br><br>Some specific cases of inversion: Veridian Forest, originally cast as a foreboding \"dungeon\" dangerous to human travelers, is recast as a site of refuge. Likewise, in the original, these creatures lack agency to navigate the world all their own--except for the privileged one selected as a trainer’s favorite who’s allowed to walk outside a pokéball’s confines, following faithfully behind its capturer. In my reimagining, upon escaping, Bulbasaur is free to traverse the world as s/he sees fit. To highlight this newly earned agency, upon reaching Route 1, Bulbasaur now has the ability to interact with his fellow creatures as s/he thinks best, best exemplified by a new choice of \"Soothe\", a non-coercive method of recruiting companions toward a goal that's truly mutual.<br><br>Finally, in the original, Trainers are afforded the opportunity to rename their recent captures. Bulbasaur, however, upon befriending a new creature, learns his/her companion's name, a name that Bulbasaur has no power (nor even attempts) to change, highlighting a revision of Pokémon's original metaphor of ownership. And in order to cement Bulbasaur's equality with those of his companions, the game's final task, i.e., the escape to Veridian forest, requires joint effort and collaboration to dismantle the barrier--effort that Bulbasaur is not excluded from, but rather, must take part in alongside his companions.<br><br><a href='https://pedromarinyo.github.io/monsterPocket/'>Play the game</a>.<br><br><img width='100%' class='projectDetailsImg' src='assets/monsterPocket1.png'><br><br><img width='100%' class='projectDetailsImg' src='assets/monsterPocket2.png'><br><br><img width='100%' class='projectDetailsImg' src='assets/monsterPocket3.png'><br><br><img width='100%' class='projectDetailsImg' src='assets/monsterPocket4.png'>";

aboutContent["timeline"] = "Timeline is an interface and authoring tool for stories that allow interactors to explore scenarios with multiple variables in order to get a fuller understanding of a complex situation. The system allows authors to create stories as a series of dramatic beats that vary according to up to three sets of variables. The Timeline interface supports interactors in juxtaposing moments in the story under different conditions.<br><br>This system has been used by Prof. Janet Murray's Interactive Fiction (undergraduate) and Interactive Narrative (graduate) classes as a tool for prototyping replay stories.<br><br><b>Publication</b><br>Pedro Silva, Shuyu Gao, Michelle Ramirez, Sanjeev Nayak, Colin Stricklin, Janet H. Murray. 2021. Timeline: An Authoring Platform for Parameterized Stories. In Proceedings of the ACM International Conference on Interactive Media Experiences (IMX ‘21). ACM, New York, NY, USA.<br><br><b>Example Student Stories</b>:<br><a href='https://pedromarinyo.github.io/relivingLastNight/'>Sara Cooper's <i>Reliving Last Night</i></a><br><a href='https://sites.gatech.edu/penlab21/2021/10/22/now-or-forever/'>Colin Stricklin's <i>Now, or Forever</i></a><br><a href='https://sites.gatech.edu/penlab21/2021/10/22/northbound/'>Michelle Ramierez's <i>Northbound</i></a><br><br><iframe title='YouTube video player' src='https://www.youtube.com/embed/X1gXOV7p3U0' width='100%' height='315' frameborder='0' allowfullscreen='allowfullscreen'></iframe><br><br><iframe width='100%' height='315' src='https://www.youtube.com/embed/desvBZg9IqE' title='YouTube video player' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe><br><br><img width='100%' class='projectDetailsImg' src='assets/timeline2.png'>";

aboutContent["sunshineExpress"] = "Virtual reality adds new vectors of expression onto an interactor’s experience of an interactive digital narrative (IDN). In an effort to leverage VR’s affordances for storytelling, this thesis aims to present a prototype that:<br><br>(1) Explores best practices surrounding dramatically evocative gestures as levers for traversing an IDN’s storyspace.<br><br>(2) Allows for an exploratory analysis of these gestures’ effects, with emphasis on role-identification and presence.<br><br><b>Premise:</b><br>An amateur shipwreck explorer has pilfered his latest discovery: a 19th Century urn pulled from a sunken steamer. The Sunshine Express departs from Florida’s Keys and skirts the gulf on its way to Tallahassee. <br><br><b>The Player</b>:<br> the urn’s ghost, capable of possessing its fellow passengers.<br><br><b>The Objective</b>:<br> To alert authorities at the head of the train; to journey from caboose to steam engine by possessing and piggybacking on passengers. Each railcar operates as a puzzle; the interactor must engineer a narrative scenario that motivates a character to continue on to the next car.<br><br><img width='100%' class='projectDetailsImg' src='assets/sunshineExpress2.png'><br><br><img width='100%' class='projectDetailsImg' src='assets/sunshineExpress3.png'>";
